...
public class RegistrationPage {
    ...
    public WebElement roomSave2;

    @FindBy(xpath="(//div[text()='This field is required.'])[2]")
    public WebElement roomPriceInvalidFeedback;

    @FindBy(xpath="(//div[@role='alert']")
    public WebElement roomCreateAlert;

    @FindBy(xpath="(//span[normalize-space()='Room Type']")
    public WebElement roomTypeSiralama;

    @FindBy(xpath = "//span[contains(text(),'Back')]")
    public WebElement roomBackButton;

    @FindBy(xpath = "//div[@style='pointer-events: none;']")
    public WebElement solUstMesaj;

    @FindBy(xpath = "//span[contains(text(),'Room')]")
    public WebElement roomsSayfaBaslik;

    @FindBy(xpath ="//tbody/tr")
    public List<WebElement> tumKayitlar;

    @FindBy(xpath = "//span/span[.='Delete']")
    public List<WebElement> roomDelete;

    @FindBy(id = "jhi-confirm-delete-room")
    public WebElement deleteConfirm;

    @FindBy(xpath = "//span/span[.='Edit']")
    public List<WebElement> roomEdit;
